...
INSERT INTO animals	(name_of_animal)
VALUES	('Penguins'),
		('Gorillas'),
		('Lions'),
		('Zebras'),
...
INSERT INTO animal_info	(name_of_animal, population, feed)
VALUES	('Penguins', 10, 'fish'),
		('Gorillas', 4, 'bananas'),
		('Lions', 12, 'meat'),
		('Zebras', 4, 'grass'),
		('Elephants', 18, 'branches');
