...
FROM '/Users/shadowsgeneraldealer/YourDirectory/pls_fy2014_pupld14a.csv'
...
FROM '/Users/shadowsgeneraldealer/YourDirectory/pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER);
...
--1.
SELECT 	min(pitusr) AS total_available,
		min(gpterms) AS total_used
FROM pls_fy2014_pupld14a;
