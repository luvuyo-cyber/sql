...
FROM '/Users/shadowsgeneraldealer/YourDirectory/yellow_tripdata_2016_06_01.csv'
...
SET timezone TO 'US/Eastern'; --for results to match book
...
TO '/Users/shadowsgeneraldealer/YourDirectory/hourly_pickups_2016_06_01.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
SELECT segment,
       to_char(departure, 'YYYY-MM-DD HH12:MI a.m. TZ') AS departure, --formats departure time(12 hour format, AM/PM notation, TZ displays timezone)
...
SELECT segment,
       arrival - departure AS segment_time,
       sum(arrival - departure) OVER (ORDER BY trip_id) AS cume_time --we get 2 values that reference the same thing in cume_time
