...
COPY char_data_types TO '/Users/shadowsgeneraldealer/YourDirectory/typetest.txt'
...
--TRY IT YOURSELF
--1. NUMERIC OR DECIMAL WOULD FIT BECAUSE WE WANT ONE DIGIT AFTER THE DECIMAL AND FLOATING TYPES CAN CAUSE ERRORS
--2. WE CAN USE VARCHAR/CHAR/TEXT. WE SEPERATE THEM SO OUR DATA IS EASIER TO INVESTIGATE
--3. ITS GOING TO GIVE OUT AN ERROR BECAUSE THAT IS NOT A VALID DATE FORMAT
