...
FROM '/Users/shadowsgeneraldealer/YourDirectory/us_counties_2010.csv'
WITH (FORMAT CSV, HEADER);
...
FROM '/Users/shadowsgeneraldealer/YourDirectory/supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);
...
--See supervisor_salaries_temp table
...
COPY us_counties_2010
TO '/Users/shadowsgeneraldealer/YourDirectory/us_counties_export.txt'
...
TO '/Users/shadowsgeneraldealer/YourDirectory/us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
